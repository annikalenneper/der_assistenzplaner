...
class ShiftFormState extends State<ShiftForm> {
  ...
  String getInitialStart(){
    return (widget.editShiftStart != null) 
      ? formatTimeOfDay(TimeOfDay.fromDateTime(widget.editShiftStart!))
      : "08:00";
  }

  String getInitialEnd(){
    return (widget.editShiftEnd != null) 
      ? formatTimeOfDay(TimeOfDay.fromDateTime(widget.editShiftEnd!))
      : "16:00";
  }
  ...
  void initState() {
    super.initState();
    // Format date as DD.MM.YYYY without weekday for proper parsing
    ...
    _startDateController.text = "$day.$month.$year";
    _endDateController.text = "$day.$month.$year";
  ...
  Future<void> _pickDate(TextEditingController controller) async {
    ...
    if (picked != null) {
      ...
      controller.text = "$day.$month.$year"; // Ohne Wochentag für korrektes Parsing
    }
  }
